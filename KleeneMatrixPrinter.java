 ...
 */
public class KleeneMatrixPrinter {
...
enum K3 {
    ...
    public static K3 negationOperator(K3 a, K3 b) {
        switch (a) {
            case Falsity: return Truth;
            case Indefiniteness: return Indefiniteness;
            case Truth: return Falsity;
        }
        return null;
    }
    ...
    public static K3 implicationOperator(K3 a, K3 b) {
        switch (a) {
            case Falsity:
                switch (b) {
                    case Falsity: case Indefiniteness: case Truth: return Truth;
                }
            case Indefiniteness:
                switch (b) {
                    case Falsity: case Indefiniteness: return Indefiniteness;
                    case Truth: return Truth;
                }
            case Truth:
                switch (b) {
                    case Falsity: return Falsity;
                    case Indefiniteness: return Indefiniteness;
                    case Truth: return Truth;
                }
        }
    ...
    public static K3 conjunctionOperator(K3 a, K3 b) {
        switch (a) {
            case Falsity:
                switch (b) {
                    case Falsity: case Indefiniteness: case Truth: return Falsity;
                }
            case Indefiniteness:
                switch (b) {
                    case Falsity: return Falsity;
                    case Indefiniteness: case Truth: return Indefiniteness;
                }
            case Truth:
                switch (b) {
                    case Falsity: return Falsity; case Indefiniteness: return Indefiniteness;
                    case Truth: return Truth;
                }
        }
        return null;
    ...
    public static K3 equivalenceOperator(K3 a, K3 b) {
        switch (a) {
            ...
            case Indefiniteness:
                switch (b) {
                    case Falsity: case Indefiniteness: case Truth: return Indefiniteness;
                }
            case Truth:
                switch (b) {
                    case Falsity: return Falsity;
